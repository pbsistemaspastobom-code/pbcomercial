...
const MEDAL = ["#E8B800", "#b8bcc4", "#cd7f32"]; // ouro, prata, bronze
      ...
      <div className="card-soft p-5">
        ...
        <div className="overflow-auto">
          <table className="w-full text-sm">
            ...
            <tbody>
              {ranked.map((l, i) => {
                const cor = l.atingimento >= 100 ? "#1f7a1a" : l.atingimento >= 80 ? "#9A7A00" : "#9A7A00";
                return (
                  <tr key={l.codigo} className="border-b border-[#f1f3f4]">
                    ...
                    <td className="py-3 w-40">
                      <div className="h-2 rounded-full bg-[#eef1eb] overflow-hidden">
                        <div className="h-full rounded-full" style={{ width: `${Math.min((l.vendaLiquida / maxVenda) * 100, 100)}%`, background: "#3A7D2E" }} />
                      </div>
                    </td>
